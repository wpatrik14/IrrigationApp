...
STATIC_URL = '/static/'
TEMPLATE_DIRS = os.path.join(BASE_DIR,'templates/IrrigationApp'),
STATICFILES_DIRS = (
...
EMAIL_PORT = '587'
EMAIL_HOST_USER = 'godlocsolas@gmail.com'
EMAIL_HOST_PASSWORD = 'bogi1965'
EMAIL_USE_TLS = True
...
CELERYBEAT_SCHEDULE = {
    ...
    'getSwitchData': {
        'task': 'IrrigationApp.tasks.getSwitchData',
        'schedule': crontab(minute=2, hour='*/1'),
    },
    'doForecast': {
        'task': 'IrrigationApp.tasks.doForecast',
