...
def showMoistureHistory(request):
    ...
    moistureHistories = MoistureHistory.objects.filter(zone_id=zone).order_by('date')[:80]
...
def showWeatherHistory(request):
    ...
    weatherHistories = WeatherHistory.objects.all().order_by('observation_time')[:80]
